...
- `tests/` — protocol, privacy, and web-security regressions.
...
No remote agent, remote client, school-management integration, exporter, or diagnostic
browser asset is part of the active runtime. The application never spawns an external
interpreter and never writes a card image to disk.
